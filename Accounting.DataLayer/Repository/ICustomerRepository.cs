...
namespace Accounting.DataLayer.Repository
{
    public interface ICustomerRepository
    {
        ...
        List<Products> GetProducts(string command , string filters = "");
        List<Products> GetProductsByID(string command ,int ID);
        List<ReceivedOrPay>ReceivedOrPay();
